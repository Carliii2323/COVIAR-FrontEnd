...
export async function GET(
    ...
    try {
        ...
        logger.log('Proxy: Obteniendo resultados de autoevaluación', id)
        ...
        if (!response.ok) {
            logger.error('Proxy: Error al obtener resultados:', response.status, data)
        ...
        logger.log('Proxy: Resultados obtenidos:', data)
